...
if (
  ...
  console.log("TibiaGame V21 fixed render-slot ring is already applied.");
  process.exit(0);
}
...
if (CHECK_ONLY) {
  console.log("V21 compatibility check passed. No files were changed.");
  ...
  console.log("  V20.3 runtime frontier prefetch: still disabled");
...
console.log("Applied TibiaGame V21 fixed render-slot ring.");
console.log("Changed:");
