...
describe("world pointer interactions", () => {
  ...
  it("takes loot from a non-empty corpse even when an empty corpse is first on the tile", () => {
    ...
    world.players.set("player", { id: "player", name: "Hero", outfit: "knight", secondarySkills: [], position: { x: 4, y: 4, z: 7 }, health: 100, maxHealth: 100, level: 1, experience: 0, mana: 0, maxMana: 0, swordSkill: 1, swordTries: 0, distanceSkill: 1, distanceTries: 0, shieldingSkill: 10, shieldingTries: 0, fletchingSkill: 1, fletchingTries: 0, magicLevel: 0, magicTries: 0 });
    world.groundItems = [
