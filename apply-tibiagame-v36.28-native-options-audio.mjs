...
const settingsSource = `// TIBIAGAME_V36_28_NATIVE_OPTIONS_AUDIO
...
if (!versionFile.includes('pub const MIGRATION_VERSION: &str = "36.28";')) {
...
if (fs.existsSync(path.join(ROOT, DOC))) {
  let doc = read(DOC);
  const marker =
    "<!-- TIBIAGAME_V36_28_NATIVE_OPTIONS_AUDIO -->";
...
V36.28 migrates native options, persistent audio settings, a lightweight
...
const checks = [
  ...
  [finalVersion.includes('pub const MIGRATION_VERSION: &str = "36.28";'), "version is not V36.28"],
];
